...
def parse_args():
    ...
    p.add_argument("--certify_dir", type=str, default=str(ROOT / "outputs" / "certifications" / "isic"))
    p.add_argument("--heatmap_dir", type=str, default=str(ROOT / "outputs" / "attributions_viz" / "isic" / "certified_maps"))
